...
| 2 | **モデル出し分けがそのままコスト設計になる** | 高品質モデルは 1 回、安価モデルは 10〜15 回。**回数 × 単価**で投資先が決まる。実測で 45% のコスト削減（設問数により 45〜68% に変動 / [cost-model.md §5.2](docs/cost-model.md#52-出し分けの効果)） |
...
今後の計画は [ロードマップ](docs/roadmap.md) を参照してください。
