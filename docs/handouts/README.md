...
| 資料 | 原稿 | 生成物 | 元にした設計書 |
|---|---|---|---|
| コスト価格表 | [cost-pricing.html](cost-pricing.html) | cost-pricing.pdf | [cost-model.md](../cost-model.md) |
| セキュリティ説明 | [security.html](security.html) | security.pdf | [security.md](../security.md) |
